...
if ((paramsArray select 5) == 1) then {
	_this addAction ["<t color='#4040FF'>Unarmed Osprey</t>", {["UK3CB_B_Osprey_USMC_D", "jetspawn3", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];
	
	_this addAction ["<t color='#4040FF'>Armed Osprey</t>", {["UK3CB_B_Osprey_IDWS_HMG_USMC_D", "jetspawn3", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];

	_this addAction ["<t color='#4040FF'>C130J</t>", {["RHS_C130J", "jetspawn3", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];
};
