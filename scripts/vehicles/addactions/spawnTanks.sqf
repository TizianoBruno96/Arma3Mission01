...
if ((paramsArray select 5) == 1) then {
	_this addAction ["<t color='#4040FF'>Abrams tank</t>", {["rhsusf_m1a1aimd_usarmy", "vehspawn4", 26] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];
	
	_this addAction ["<t color='#4040FF'>Abrams tank TUSK I</t>", {["rhsusf_m1a2sep1tuskid_usarmy", "vehspawn4", 26] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];

	_this addAction ["<t color='#4040FF'>Abrams tank TUSK II</t>", {["rhsusf_m1a2sep1tuskiid_usarmy", "vehspawn4", 26] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];
};

// Adding the actions for the Rebel side
if ((paramsArray select 6) == 1) then {
	_this addAction ["<t color='#40FF40'>T34-85M Tank</t>", {["UK3CB_TKM_I_T34", "vehspawn4", 26] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo INDEPENDENT)", 5, false, "", ""];
	
	_this addAction ["<t color='#40FF40'>T55A Tank</t>", {["UK3CB_TKM_I_T55", "vehspawn4", 26] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo INDEPENDENT)", 5, false, "", ""];
};
