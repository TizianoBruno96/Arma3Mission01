...
if ((paramsArray select 5) == 1) then {
	_this addAction ["<t color='#4040FF'>Unarmed Transport</t>", {["rhsusf_M1078A1P2_D_fmtv_usarmy", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];
	
	_this addAction ["<t color='#4040FF'>Armed Transport</t>", {["rhsusf_M1078A1P2_B_M2_D_fmtv_usarmy", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];

	_this addAction ["<t color='#4040FF'>Ammo Hemmt</t>", {["rhsusf_M977A4_AMMO_BKIT_M2_usarmy_d", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];
	
	_this addAction ["<t color='#4040FF'>Repair Hemmt</t>", {["rhsusf_M977A4_REPAIR_BKIT_M2_usarmy_d", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];

	_this addAction ["<t color='#4040FF'>Medical Hemmt</t>", {["rhsusf_M1085A1P2_B_D_Medical_fmtv_usarmy", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];
	
	_this addAction ["<t color='#4040FF'>Fuel Hemmt</t>", {["rhsusf_M978A4_BKIT_usarmy_d", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned && (side player isEqualTo WEST)", 5, false, "", ""];
};
