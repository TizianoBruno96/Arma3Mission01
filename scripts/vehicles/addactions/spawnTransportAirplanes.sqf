...
_this addAction ["<t color='#FFFFFF'>Transport Airplane Antonov AN2</t>", {["UK3CB_TKA_B_Antonov_AN2", "jetspawn1", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned", 5, false, "", ""];

_this addAction ["<t color='#FFFFFF'>Transport Airplane Cessna T41</t>", {["UK3CB_TKA_B_Cessna_T41", "jetspawn1", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned", 5, false, "", ""];

_this addAction ["<t color='#FF6666'>Delete Vehicle</t>", {["jetspawn1", 10] execVM "scripts\vehicles\deleteVeh.sqf";}, nil, 1.5, true, true, "", "", 5, false, "", ""];