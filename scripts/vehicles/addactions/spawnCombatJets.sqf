...
_this addAction ["<t color='#FF4040'>Mig-21 Anti-Air</t>", {["UK3CB_TKA_B_MIG21_AA", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned", 5, false, "", ""];

_this addAction ["<t color='#FF4040'>Mig-21 Anti-Tank</t>", {["UK3CB_TKA_B_MIG21_AT", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned", 5, false, "", ""];

_this addAction ["<t color='#FF4040'>Aero L-39 Albatross Anti-Tank</t>", {["UK3CB_TKA_B_L39_CAS", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned", 5, false, "", ""];

_this addAction ["<t color='#FF4040'>Su-25SM Anti-Tank</t>", {["UK3CB_TKA_B_Su25SM", "jetspawn2", 206] execVM "scripts\vehicles\spawnVeh.sqf";}, [], 1.5, true, true, "", "spawned", 5, false, "", ""];
