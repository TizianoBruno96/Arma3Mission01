...
if((paramsArray select 6) == 1 && (paramsArray select 4) > 0) then {
	_this addAction ["<t color='#4040FF' size='+1.5'>---------Rebel Army---------</t>", {}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>Rifleman</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\Fuciliere.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>Grenadier</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\Granatiere.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>AC Rifleman</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\FuciliereAC.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>Medic</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\Medico.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>Machine Gunner</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\Mitragliere.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>Marksman</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\Tiratore.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>Explosive Specialist</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\SpecialistaExp.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>AC Specialist</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\SpecialistaAC.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>AA Specialist</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\SpecialistaAA.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
	_this addAction ["<t color='#4040FF' size='+1.5'>Repair Specialist</t>", {["UK3CB_TKM_I_RIF_1", "unitSpawn", 315, player, "loadouts\rebelArmy\SpecialistaRep.sqf"] execVM "scripts\units\USUnitSpawn.sqf";}, nil, 1.5, true, true, "", "side player isEqualTo INDEPENDENT", 5, false, "", ""];
};
