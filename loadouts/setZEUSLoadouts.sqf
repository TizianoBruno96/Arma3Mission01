...
_this addAction ["<t color='#FF40FF'>Join Civilian</t>", {player sideChat "Joining Civilian"; [player, civilian] execVM "scripts\unitSide.sqf";}, [], 0, false, true, "", "(side player != civilian) && ((getPlayerUID player) in allowed)", 5, false, "", ""];
